...
import type { PrerequisiteCheckResult } from "./prerequisites.js";
...
export type { PrerequisiteCheckResult } from "./prerequisites.js";

export async function defaultPrerequisiteCheck(): Promise<PrerequisiteCheckResult> {
