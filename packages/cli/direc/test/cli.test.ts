...
test("initCommand detects facets and materialises sources, tools, sinks, and pipelines", async () => {
...
test("runCommand loads config and executes the diff pipeline end to end", async () => {
